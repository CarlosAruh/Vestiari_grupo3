    ...
    <div>
      ...
      <Row>
            ...
            <Card.Body>
              ...
              {order.isDelivered ? (
                <MessageBox variant="success">
                  Entregar no Endereço {order.deliveredAt}
                </MessageBox>
              ) : (
                <MessageBox variant="danger">Retirar na Loja</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Cobrança</Card.Title>
              <Card.Text>
                <strong>Forma de Pagamento:</strong> {order.paymentMethod}
              </Card.Text>
              {order.isPaid ? (
                <MessageBox variant="success">Pago {order.paidAt}</MessageBox>
              ) : (
        ...
        <Col md={4}>
          <Card className="mb-3">
            <Card.Body>
              <Card.Title>Resumo de Compra</Card.Title>
              <ListGroup variant="flush">
                <ListGroup.Item>
                  <Row>
                    <Col>Itens</Col>
